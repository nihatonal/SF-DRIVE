    ...
    return (
        <div className="notfound-container">
            ...
            <div className="notfound-content">
                ...
                <p className="notfound-text text-404">Возможно, вы ошиблись в адресе страницы, либо она была удалена.</p>
                <Button to="./" size="big" btnclass="notfound-btn">Перейти на главную</Button>
            </div>
        </div>
    )
}
